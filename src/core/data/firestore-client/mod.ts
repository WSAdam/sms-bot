...
// the import expression is invisible to Vite's static analyzer. A literal
// dynamic import of a "firebase-admin/*" subpath (even behind a @vite-ignore
// hint) makes the @fresh/plugin-vite Deno loader still resolve the specifier
// and inline firebase-admin's CJS source into the SSR bundle. The bundled CJS then
